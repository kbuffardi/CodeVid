...
* Multimedia and e-Learning Principles (Clark \& Mayer):
    ...
    * **Contiguity Principle**: text + graphics should be in close spatial and temporal proximity
    * **Modality Principle**: audio + graphics beneficial
...
* [HEERF funding for educational resiliency](https://www2.ed.gov/about/offices/list/ope/arp.html)
    - Integrating lightboard with screen sharing
